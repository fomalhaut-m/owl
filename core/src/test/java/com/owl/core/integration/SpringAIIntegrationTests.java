...
import com.owl.core.config.ApiConfig;
...
@DisplayName("Spring AI 集成测试套件")
class SpringAIIntegrationTests {

    // 注意：这些测试需要有效的 API 密钥才能运行
    // 请在运行前设置环境变量或替换为实际的 API 密钥
    
    @Test
    @DisplayName("1. 大模型调用测试")
    void testBasicLLMCall() {
        // 使用配置的 API 密钥
        ...
        System.out.println("大模型调用结果: " + result);
    }

    @Test
    @DisplayName("2. 大模型 Tools 调用测试")
    void testLLMWithTools() {
        ...
        String userInput = "请告诉我北京现在的天气怎么样？";
    ...
    @Test
    @DisplayName("3. 大模型 + MBTI 分析专家 Skills 提示词调用测试")
    void testLLMWithMBTIExpertSkills() {
        ...
        System.out.println("MBTI专家技能调用结果: " + result);
    }

    @Test
    @DisplayName("4. 大模型 + MBTI 分析专家 + 记忆整理 Skills 调用测试")
    void testLLMWithMBTIAndMemorySkills() {
        ...
        System.out.println("MBTI+记忆整理技能调用结果: " + result);
    }

    @Test
    @DisplayName("5. 目标拆解计划（Goal Decomposition Plan）测试")
    void testGoalDecompositionPlan() {
        ...
        System.out.println("目标拆解计划结果: " + result);
    }

    @Test
    @DisplayName("6. 工具调用计划（Tool Call Plan）测试")
    void testToolCallPlan() {
        ...
        System.out.println("工具调用计划结果: " + result);
    }

    @Test
    @DisplayName("7. 反思修正计划（Reflection Plan）测试")
    void testReflectionPlan() {
        ...
        System.out.println("反思修正计划结果: " + result);
    }

    @Test
    @DisplayName("8. 多轮对话推进计划（Conversation Plan）测试")
    void testConversationPlan() {
        ...
        System.out.println("多轮对话推进计划结果: " + result);
    }

    @Test
    @DisplayName("9. 代码工程计划（Code Engineering Plan）测试")
    void testCodeEngineeringPlan() {
        ...
        System.out.println("代码工程计划结果: " + result);
    }

    @Test
    @DisplayName("10. 最终总结计划（Summary Plan）测试")
    void testSummaryPlan() {
        ...
        System.out.println("最终总结计划结果: " + result);
    }
}