...
class MemoryToolsTest {
    ...
    void testSaveMemoryWithLLM() {
        ...
        String savedContent = memoryRepo.findByUserIdAndPathAndName(TEST_USER_ID, Arrays.asList("working", "P0"), "test_note.md");
    ...
    void testGetMemoryWithLLM() {
        memoryRepo.save(TEST_USER_ID, Arrays.asList("working", "P1"), "read_test.md",
    ...
    void testDeleteMemoryWithLLM() {
        memoryRepo.save(TEST_USER_ID, Arrays.asList("working", "P2"), "delete_test.md",
                "这是将要被删除的记忆。");
        ...
        String deletedContent = memoryRepo.findByUserIdAndPathAndName(TEST_USER_ID, Arrays.asList("working", "P2"), "delete_test.md");
    ...
    void testGetMemoryPathsWithLLM() {
        memoryRepo.save(TEST_USER_ID, Arrays.asList("working", "P0"), "path_test_1.md", "记忆1");
        memoryRepo.save(TEST_USER_ID, Arrays.asList("working", "P1"), "path_test_2.md", "记忆2");
        memoryRepo.save(TEST_USER_ID, Arrays.asList("long_term", "S"), "path_test_3.md", "记忆3");
    ...
    void testMemoryConsolidationWithLLM() {
        memoryRepo.save(TEST_USER_ID, Arrays.asList("working", "P0"), "recent_thought.md",
                "今天学到了关于 Java 泛型的新知识。泛型可以提供编译时类型安全。");
        memoryRepo.save(TEST_USER_ID, Arrays.asList("long_term", "S"), "java_generics.md",
        ...
        LLMAgentResponse response = llmClient.chat(consolidationPrompt)
                .tool(memoryTools)
                .call();
    ...
    void testMultiUserMemoryIsolation() {
        ...
        user2Repo.save(testUserId, Arrays.asList("working", "P0"), "user2_note.md",
                "这是 user_002 的专属记忆。");
        memoryRepo.save(TEST_USER_ID, Arrays.asList("working", "P0"), "user1_note.md",
                "这是 user_001 的专属记忆。");
    ...
    void testCompleteMemoryWorkflow() {
        ...
        String finalContent = memoryRepo.findByUserIdAndPathAndName(TEST_USER_ID, Arrays.asList("working", "P1"), "workflow_test.md");
